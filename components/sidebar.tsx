...
export function Sidebar(): React.ReactElement {
  ...
  return (
    <>
      <aside 
        className={cn(
          "fixed left-0 top-0 z-40 h-screen bg-white/95 backdrop-blur-xl border-r border-amber-100 flex flex-col transition-all duration-300 ease-in-out",
        ...
        <div className="flex flex-col h-full p-4 pt-1">
          ...
          <div className="mb-4">
            <nav className="space-y-1">
              <Link href="/dashboard" className="flex items-center gap-3 px-3 py-2 text-amber-600 bg-amber-50 rounded-lg">
                <LayoutDashboard size={20} className="flex-shrink-0" />
                <span className={cn(
                  "transform-gpu transition-all duration-300 ease-in-out overflow-hidden whitespace-nowrap",
                  isCollapsed ? "opacity-0 w-0" : "opacity-100 w-auto"
                )}>
                  Dashboard
                </span>
              </Link>
              <Link href="/legal-assistance" className="flex items-center gap-3 px-3 py-2 text-gray-600 hover:bg-amber-50 hover:text-amber-600 rounded-lg transition-colors">
              ...
              <Link href="/contracts-draft" className="flex items-center gap-3 px-3 py-2 text-gray-600 hover:bg-amber-50 hover:text-amber-600 rounded-lg transition-colors">
              ...
              <Link href="/document-analyzer" className="flex items-center gap-3 px-3 py-2 text-gray-600 hover:bg-amber-50 hover:text-amber-600 rounded-lg transition-colors">
                <FileSearch size={20} className="flex-shrink-0" />
                <span className={cn(
                  "transform-gpu transition-all duration-300 ease-in-out overflow-hidden whitespace-nowrap", 
                  isCollapsed ? "opacity-0 w-0" : "opacity-100 w-auto"
                )}>
              ...
              <Link href="/case-status" className="flex items-center gap-3 px-3 py-2 text-gray-600 hover:bg-amber-50 hover:text-amber-600 rounded-lg transition-colors">
              ...
              <Link href="/find-lawyer" className="flex items-center gap-3 px-3 py-2 text-gray-600 hover:bg-amber-50 hover:text-amber-600 rounded-lg transition-colors">
                <Briefcase size={20} className="flex-shrink-0" />
                <span className={cn(
                  "transform-gpu transition-all duration-300 ease-in-out overflow-hidden whitespace-nowrap", 
                  isCollapsed ? "opacity-0 w-0" : "opacity-100 w-auto"
          ...
          <div className="mb-4">
            <nav className="space-y-1">
              {[
                { icon: Route, label: "Pathway", href: "/pathway" },
                { icon: MessageSquareText, label: "Chatbot", href: "/chatbot" },
              ].map((item, i) => (
                <Link
                  key={i}
                  href={item.href}
                  className="flex items-center gap-3 px-3 py-2 text-gray-600 hover:bg-amber-50 hover:text-amber-600 rounded-lg transition-colors"
                >
          ...
          <div className="flex justify-center mb-2">
            <button
              ...
              className="p-2 rounded-full bg-amber-50 hover:bg-amber-100 text-amber-600 transition-all duration-300"
